 ...
 * @author Rene
 */
public class CatalogosDeSeriesFaltantes extends ConjuntoEntradaCatalogosDeSeriesConEntrada{
...
//    private FiltroSerie filtro;
    ...
    public CatalogosDeSeriesFaltantes(CatalogosDeSeriesBasicos basicos, CatalogosDeSeriesEntrada entradas, FiltroSerie filtro) {
...
// Todo = basicos.get.getCatalogoSeriesFaltantes(entradas.getTodo());
    }

    @Override
    public void actualizarSeguidos(ConfiguracionDeVideo cdv) throws FileNotFoundException {
        Seguidos = basicos.getSeguidos().getCatalogoSeriesFaltantes(entradas.getEntrada());
    }

    @Override
    public void actualizarExtrenos(ConfiguracionDeVideo cdv) throws FileNotFoundException {
        Extrenos = entradas.getExtrenos().getCatalogoSeriesFaltantes(entradas.getEntrada());
    }

    @Override
    public void actualizarEnEspera(ConfiguracionDeVideo cdv) throws FileNotFoundException {
        EnEspera = basicos.getEnEspera().getCatalogoSeriesFaltantes(entradas.getEntrada());
    }

    @Override
    public void actualizarPorVer(ConfiguracionDeVideo cdv) throws FileNotFoundException {
        PorVer = basicos.getPorVer().getCatalogoSeriesFaltantes(entradas.getEntrada());
    }
    ...
    public void actualizarFinalizadas(ConfiguracionDeVideo cdv) throws FileNotFoundException {
        ...
        Finalizadas = basicos.getFinalizadas().getCatalogoSeriesFaltantes(entradas.getEntrada());
    }

    @Override
    public void actualizarPersonalizados(ConfiguracionDeVideo cdv) throws FileNotFoundException {
        personalizados = entradas.getPersonalizadosSeleccionados().getCatalogoSeriesFaltantes(entradas.getEntrada());
