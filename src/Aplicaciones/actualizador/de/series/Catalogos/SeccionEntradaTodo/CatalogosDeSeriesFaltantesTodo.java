 ...
 * @author Rene
 */
public class CatalogosDeSeriesFaltantesTodo extends CatalogosDeSeriesFaltantes {

    private CatalogosDeSeries Cs;

    public CatalogosDeSeriesFaltantesTodo(CatalogosDeSeries Cs, CatalogosDeSeriesBasicos basicos, CatalogosDeSeriesEntrada entradas, FiltroSerie filtro) {
...
//
////        getSeguidos().addNecesarios(Cs.getEntradaClasicas().getEntrada().getSeguidos(),
////                Cs.getEntradaDobladas().getEntrada().getSeguidos(),
////                Cs.getEntradaTX().getEntrada().getSeguidos());
...
//            getSeguidos().imprimir();
    ...
    private CatalogosDeSeriesFaltantes getCatalogosDeSeries(int i) {
          return SeccionDeCatalogosDeSerieEntradaTodo.getCatalogosDeSeries(Cs, i).getFaltantes();
//        switch (i) {
//            case 0:
//                return Cs.getEntradaClasicas().getFaltantes();
//            case 1:
//                return Cs.getEntradaDobladas().getFaltantes();
//            case 2:
//                return Cs.getEntradaTX().getFaltantes();
//
//        }
//        return null;
    }

    private CatalogosDeSeriesFaltantes getCatalogosDeSeriesPersonalizada(int i) {
        return Cs.getPersonalizadasEntrada().get(i).getFaltantes();
    }
}
