...
public class ModificarExtencion {
    ...
    public static Ventana_Direcciones ventanaDirecciones;
    public static Ventana_Nueva_Direccion ventanaNuevaDireccion;
//    public static Ventana_Mover_Numero_Configuracion ventanaMoverNumeroConfiguracion;
//    public static Ventana_Administrador_Configuraciones ventanaAdministradorConfiguraciones;
    public static Ventana_Canviar_Direccion ventanaCanviarDireccion;
    public static Ventana_ConfiguracionDeVideo ventana_ConfiguracionDeVideo;
    public static final String DIRECCION_ESTADO_ACTUAL = "Data/Modificar Extencion/Estado Actual.conf",
            DIRECCION_ADMINISTRADOR_CONFIGURACIONES = "Data/Modificar Extencion/Administrador de Configuraciones.ads"
            ,DIRECCION_ADMINISTRADOR_DIRECCIONES="Data/Modificar Extencion/Administrador.adm";
