 ...
 * @author Rene
 */
public class Tiempo2 implements Serializable {
    ...
    public Tiempo2(int Hora, int Minuto, int Segundo, int MSegundo) {
        this(Hora, Minuto, Segundo, MSegundo, false);
    }

    public Tiempo2(int Hora, int Minuto, int Segundo, int MSegundo, boolean admitirNegativo) {
    ...
    public void aumentar(Tiempo2 t) {
        aumentar(t.getHora(), t.getMinuto(), t.getSegundo(), t.MSegundo);
    }

    public void restar(Tiempo2 t) {
        restar(t.getHora(), t.getMinuto(), t.getSegundo(), t.MSegundo);
    }

    public Tiempo2 copia(boolean admitirNegativo) {
        return new Tiempo2(Hora, Minuto, Segundo, MSegundo, admitirNegativo);
    }

    public Tiempo2 copia() {
        return new Tiempo2(Hora, Minuto, Segundo, MSegundo, admitirNegativo);
    }
