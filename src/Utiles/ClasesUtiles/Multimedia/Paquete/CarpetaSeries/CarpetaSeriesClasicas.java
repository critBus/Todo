 ...
 * @author Rene
 */
public class CarpetaSeriesClasicas extends CarpetaConSeries {

    public CarpetaSeriesClasicas() {
        super();
    }

    public CarpetaSeriesClasicas(File F, String[] invalidos, ConfiguracionDeVideo cdv) throws FileNotFoundException {
